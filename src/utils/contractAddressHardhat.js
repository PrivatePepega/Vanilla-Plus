...
export const contractAddresses = {
  ...
  Money: LocalBankMoneyAddress,
  TimeLock: LocalBankTimeLockAddress,
  Governor: LocalBankGovernorAddress,
  Passport: LocalBankPassportAddress,
  PassportFollowList: LocalBankPassportFollowListAddress,
  PassportFrenList: LocalBankPassportFrenListAddress,
