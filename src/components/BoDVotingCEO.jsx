...
const BoDVotingCEO = () => {
  ...
  //   method: "function viewCandidateCEOArray() returns (address[])",
  // });
  ...
  return (
    <div className="mt-7">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div>
          TOP 5 CEO Candidates: {viewTopCandidatesArray ? viewTopCandidatesArray?.map((tx) => tx.toString()).join(", ") : null}
        </div>
      </div>
